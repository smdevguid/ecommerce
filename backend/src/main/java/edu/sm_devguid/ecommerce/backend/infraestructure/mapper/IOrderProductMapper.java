...
import edu.sm_devguid.ecommerce.backend.domain.model.OrderProduct;
import edu.sm_devguid.ecommerce.backend.infraestructure.entity.OrderProductEntity;
...
public interface IOrderProductMapper {
    ...
    OrderProductEntity toOrderProdctEntity(OrderProduct orderProduct);
}
